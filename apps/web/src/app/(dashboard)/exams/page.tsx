    ...
    <div className="p-6 space-y-5">
      <div className="flex items-center justify-between flex-wrap gap-4">
        ...
        <div className="flex items-center gap-3">
          {canNew && (
            <Link href="/grade-scales" className="px-4 py-2 text-sm font-medium text-text-700 border border-border rounded-md hover:bg-surface-50 transition-colors">
              Grade Scales
            </Link>
          )}
          {canNew && (
            <Link href="/exams/new" className="px-4 py-2 text-sm font-medium text-white bg-spira-700 rounded-md hover:bg-spira-800 transition-colors">
              + New exam
            </Link>
          )}
        </div>
